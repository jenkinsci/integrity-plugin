...
public class IntegritySCMCheckinStep extends AbstractStepImpl
{
  ...
  public static class IntegritySCMCheckinStepExecution
      extends AbstractSynchronousStepExecution<Void>
  {
    ...
    {
      IntegritySCMCheckinNotifierStep notifier =
          new IntegritySCMCheckinNotifierStep(step.getConnectionSettings(), step.getConfigPath(),
