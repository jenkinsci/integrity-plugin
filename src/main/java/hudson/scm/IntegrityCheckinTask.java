...
public class IntegrityCheckinTask implements FileCallable<Boolean>
{
      ...
      IntegrityConfigurable integrityConfig) throws Exception
  {
    ...
    LOGGER.fine("PTC RV&S Checkin Task Created!");
  }
  ...
  public Boolean invoke(File workspaceFile, VirtualChannel channel) throws IOException
  {
    ...
    listener.getLogger().println(
        "PTC RV&S project '" + ciConfigPath + "' will be updated from directory " + workspace);
    ...
    try
    {
      ...
      if (artifacts.length > 0)
      {
        ...
        // Log the success
        listener.getLogger().println("Successfully updated PTC RV&S project '" + ciConfigPath
    ...
    } catch (InterruptedException iex)
    {
      ...
      listener.getLogger().println("Failed to update PTC RV&S project '" + ciConfigPath
          + "' with contents of workspace (" + workspace + ")!");
      return false;
