...
public class IntegritySCMCheckinNotifierStep extends Notifier implements SimpleBuildStep
{
      ...
      throws InterruptedException, IOException
  {
    listener.getLogger().println(
        "PTC RV&S project '" + configPath + "' will be updated from directory " + workspace);
    listener.getLogger()
    ...
    while (true) {
        try
        {
          ...
          if (artifacts.length > 0)
          {
            ...
            // Log the success
            listener.getLogger().println("Successfully updated PTC RV&S project '" + configPath
        ...
        } catch (InterruptedException iex)
        {
          ...
          listener.getLogger().println("Failed to update PTC RV&S project '" + configPath
              + WITH_CONTENTS_OF_WS + workspace + ")!");
          throw iex;
