...
public class IntegrityDeleteNonMembersAction extends Notifier implements Serializable
{
  ...
  @Extension
  public static final IntegrityDeleteNonMembersDescriptorImpl DELETENONMEMBERS_DESCRIPTOR =
      new IntegrityDeleteNonMembersDescriptorImpl();
      ...
      throws InterruptedException, IOException
  {
    ...
    if (!(rootProject.getScm() instanceof IntegritySCM))
    {
      listener.getLogger().println(
          "Integrity DeleteNonMembers is being executed for an invalid context!  Current SCM is "
              + rootProject.getScm() + "!");
      return true;
    }
   ...
   * class and object. This means the descriptor is used to create instances of the describable.
   * Usually the Descriptor is an internal class in the IntegrityDeleteNonMembersAction class named
   * DescriptorImpl.
   */
